...
public class Switch extends CommandGroup {
	...
	public Switch(boolean dir) {
		//addParallel(new RunLift(), 6.0);
		addSequential(new DriveForwardDistance(-.65, 149));
		addSequential(new TurnEncoder(dir, 9));
		...
		//addSequential(new TurnEncoder(true, 12));
		//addSequential(new DriveForwardDistance( -0.65, 70));
		//addSequential(new TurnEncoder(false, 6));
		//addSequential(new DriveForwardDistance(-0.65, 36.06));
		//addSequential(new TurnEncoder(false, 7));
