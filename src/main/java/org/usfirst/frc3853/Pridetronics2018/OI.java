...
public class OI {
  ...
  public OI() {
    ...
    gamepad0 = new Joystick(0); // Port 0 SECONDARY
    gamepad1 = new Joystick(1); // Port 1 SECONDARY
    // Claw Commands
    ...
    liftExtend = new JoystickButton(gamepad0, 6);
    liftExtend.whileHeld(new liftUp());

    liftRetract = new JoystickButton(gamepad0, 5);
    ...
    hookRaise = new JoystickButton(gamepad0, 2);
    hookRaise.whileHeld(new hookRaise());

    hookLower = new JoystickButton(gamepad0, 1);
    hookLower.whileHeld(new hookLower());

    hookBrakeOff = new JoystickButton(gamepad0, 3);
    hookBrakeOff.whileHeld(new hookBrakeOff());

    hookBrakeOn = new JoystickButton(gamepad0, 4);
    hookBrakeOn.whileHeld(new hookBrakeOn());

    // Autonomous Commands

    // TurnDegrees = new JoystickButton(gamepad0, 9);
